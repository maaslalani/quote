...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			align: $author$project$Main$Left,
			font: 'serif',
			meta: false,
			quote: {author: '— Oscar Wilde', text: 'Be yourself; everyone else is already taken.'},
			size: {height: 400, width: 400},
			theme: {background: '#FFFFFF', foreground: '#333333'}
		},
...
var $author$project$Main$exportImage = _Platform_outgoingPort(
	'exportImage',
	function ($) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ExportImage':
				return _Utils_Tuple2(
					model,
					$author$project$Main$exportImage(_Utils_Tuple0));
			case 'KeyUp':
				var key = msg.a;
				if (key === 'Meta') {
					return _Utils_Tuple2(
			...
			default:
				var key = msg.a;
				if (key === 'e') {
					return model.meta ? _Utils_Tuple2(
						model,
						$author$project$Main$exportImage(_Utils_Tuple0)) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Main$ExportImage = {$: 'ExportImage'};
...
var $author$project$Main$SetAlign = function (a) {
	return {$: 'SetAlign', a: a};
};
...
var $author$project$Main$ternary = F3(
	function (condition, consequent, alternate) {
...
var $author$project$Main$alignIcon = function (align) {
	var width = $rtfeldman$elm_css$Svg$Styled$Attributes$width;
	var height = $rtfeldman$elm_css$Svg$Styled$Attributes$height;
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Svg$Styled$Attributes$y('2'),
						width('14'),
						height('1')
					]),
				_List_Nil),
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Svg$Styled$Attributes$y('6'),
						height('1'),
						width(
						A3(
							$author$project$Main$ternary,
							_Utils_eq(align, $author$project$Main$Center),
							'10',
							'14')),
				...
				_List_fromArray(
					[
						...
						A3(
							$author$project$Main$ternary,
							_Utils_eq(align, $author$project$Main$Right),
							'4',
							'0')),
						width(
						A3(
...
var $author$project$Main$stylesheet = function (model) {
	return {
		activeButton: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$backgroundColor(
					$rtfeldman$elm_css$Css$hex('fff')),
					$rtfeldman$elm_css$Css$color(
					$rtfeldman$elm_css$Css$hex('1e1e20')),
					A5(
		...
		button: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$backgroundColor(
					$rtfeldman$elm_css$Css$hex('f4f4f5')),
					$rtfeldman$elm_css$Css$color(
					$rtfeldman$elm_css$Css$hex('83838b')),
					A2(
		...
		buttonGroup: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$backgroundColor(
					$rtfeldman$elm_css$Css$hex('f4f4f5')),
		...
		container: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$displayFlex,
					$rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
		...
		editorContainer: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$flex(
					$rtfeldman$elm_css$Css$int(1))
				])),
		editorSection: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					A2(
					$rtfeldman$elm_css$Css$margin2,
		...
		editorWrapper: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Css$hex('e7ebee'))
				])),
		exportButton: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$backgroundColor(
					$rtfeldman$elm_css$Css$hex('18181b')),
					$rtfeldman$elm_css$Css$color(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$backgroundColor(
							$rtfeldman$elm_css$Css$hex('2e2e34'))
						]))
				])),
		kbd: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					A2(
					$rtfeldman$elm_css$Css$padding2,
					...
					$rtfeldman$elm_css$Css$color(
					$rtfeldman$elm_css$Css$hex('1f2329')),
					$rtfeldman$elm_css$Css$backgroundColor(
		...
		quoteAuthor: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$fontSize(
		...
		quoteContainer: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$flex(
					...
					$rtfeldman$elm_css$Css$displayFlex,
					$rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
					$rtfeldman$elm_css$Css$textAlign(
					function () {
						var _v0 = model.align;
						switch (_v0.$) {
							case 'Right':
							...
							case 'Center':
								return $rtfeldman$elm_css$Css$center;
							default:
								return $rtfeldman$elm_css$Css$left;
						}
					}())
				])),
		quoteMask: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$borderRadius(
					$rtfeldman$elm_css$Css$px(16)),
		...
		quoteText: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$fontSize(
					$rtfeldman$elm_css$Css$em(1.35)),
					$rtfeldman$elm_css$Css$outline($rtfeldman$elm_css$Css$none),
					$rtfeldman$elm_css$Css$width(
					$rtfeldman$elm_css$Css$pct(60)),
					A2(
		...
		quoteWrapper: $rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$fontFamilies(
					_List_fromArray(
						[model.font])),
					$rtfeldman$elm_css$Css$height(
					$rtfeldman$elm_css$Css$px(model.size.height)),
					$rtfeldman$elm_css$Css$width(
					$rtfeldman$elm_css$Css$px(model.size.width)),
					$rtfeldman$elm_css$Css$backgroundColor(
					$rtfeldman$elm_css$Css$hex(model.theme.background)),
					$rtfeldman$elm_css$Css$color(
					$rtfeldman$elm_css$Css$hex(model.theme.foreground)),
					$rtfeldman$elm_css$Css$displayFlex,
					$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column),
					$rtfeldman$elm_css$Css$justifyContent($rtfeldman$elm_css$Css$center),
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$Transitions$background(250),
							$rtfeldman$elm_css$Css$Transitions$color(250),
							$rtfeldman$elm_css$Css$Transitions$width(250),
							$rtfeldman$elm_css$Css$Transitions$height(250)
						]))
				]))
	};
};
var $author$project$Main$alignButton = F2(
	function (model, align) {
		var styles = $author$project$Main$stylesheet(model);
		var isActive = _Utils_eq(model.align, align);
		var style = isActive ? styles.activeButton : styles.button;
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$SetAlign(align))
				]),
			_List_fromArray(
				[
					$author$project$Main$alignIcon(align)
				]));
	});
...
var $author$project$Main$editorLabel = function (children) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$color(
						$rtfeldman$elm_css$Css$hex('635852')),
...
var $author$project$Main$fontButton = F2(
	function (model, font) {
		var styles = $author$project$Main$stylesheet(model);
		var isActive = _Utils_eq(model.font, font);
		return A2(
			$rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Html$Styled$Events$onClick(
					$author$project$Main$SetFont(font))
				]),
			_List_fromArray(
				[
...
var $author$project$Main$sizeButton = F2(
	function (model, size) {
		var styles = $author$project$Main$stylesheet(model);
		var isActive = _Utils_eq(model.size.width, size);
		return A2(
			$rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
...
var $author$project$Main$themeButton = F2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$color(
							$rtfeldman$elm_css$Css$hex(theme.foreground)),
							$rtfeldman$elm_css$Css$backgroundColor(
							$rtfeldman$elm_css$Css$hex(theme.background)),
							$rtfeldman$elm_css$Css$displayFlex,
							$rtfeldman$elm_css$Css$justifyContent($rtfeldman$elm_css$Css$center),
							$rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
							$rtfeldman$elm_css$Css$width(
							...
							$rtfeldman$elm_css$Css$em(0)),
							$rtfeldman$elm_css$Css$cursor($rtfeldman$elm_css$Css$default),
							(_Utils_eq(theme.foreground, model.theme.foreground) && _Utils_eq(theme.background, model.theme.background)) ? A3(
							$rtfeldman$elm_css$Css$border3,
							$rtfeldman$elm_css$Css$px(1),
							$rtfeldman$elm_css$Css$solid,
							A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.8)) : A3(
							$rtfeldman$elm_css$Css$border3,
							$rtfeldman$elm_css$Css$px(1),
							$rtfeldman$elm_css$Css$solid,
							...
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Css$Transitions$transform(150),
					...
					$rtfeldman$elm_css$Html$Styled$Events$onClick(
					$author$project$Main$SetTheme(theme))
				]),
			_List_fromArray(
				[
...
var $author$project$Main$themes = _List_fromArray(
	[
		...
		{background: '#d6ccc2', foreground: '#463f3a'},
		{background: '#f5ebe0', foreground: '#5e503f'},
		{background: '#e3d5ca', foreground: '#8a817c'},
		{background: '#d5bdaf', foreground: '#ffffff'}
	]);
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$Attributes$id('quote'),
													styles.quoteWrapper
												]),
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$text(model.quote.text)
														])),
													A2(
													$rtfeldman$elm_css$Html$Styled$div,
													_List_fromArray(
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$text(model.quote.author)
														]))
												]))
										]))
								])),
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$author$project$Main$editorLabel(
															_List_fromArray(
																[
																	$rtfeldman$elm_css$Html$Styled$text('Theme')
																])),
															A2(
															$rtfeldman$elm_css$Html$Styled$div,
															_List_fromArray(
															...
															A2(
																$elm$core$List$map,
																function (theme) {
																	return A2($author$project$Main$themeButton, model, theme);
																},
																$author$project$Main$themes))
														]))
												])),
											A2(
											$rtfeldman$elm_css$Html$Styled$div,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															A2($author$project$Main$sizeButton, model, 250),
															A2($author$project$Main$sizeButton, model, 400),
															A2($author$project$Main$sizeButton, model, 600)
														]))
												])),
											A2(
											$rtfeldman$elm_css$Html$Styled$div,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															A2($author$project$Main$fontButton, model, 'serif'),
															A2($author$project$Main$fontButton, model, 'sans-serif'),
															A2($author$project$Main$fontButton, model, 'monospace'),
															A2($author$project$Main$fontButton, model, 'cursive')
														]))
												])),
											A2(
											$rtfeldman$elm_css$Html$Styled$div,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$text('Alignment')
														])),
													A2(
													$rtfeldman$elm_css$Html$Styled$div,
													_List_fromArray(
													...
													_List_fromArray(
														[
															A2($author$project$Main$alignButton, model, $author$project$Main$Left),
															A2($author$project$Main$alignButton, model, $author$project$Main$Center),
															A2($author$project$Main$alignButton, model, $author$project$Main$Right)
														]))
												])),
											A2(
											$rtfeldman$elm_css$Html$Styled$div,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															styles.exportButton,
															$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$ExportImage)
														]),
													_List_fromArray(
														[
															$rtfeldman$elm_css$Html$Styled$text('Export')
